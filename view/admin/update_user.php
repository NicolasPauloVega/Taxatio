            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border-success text-dark" id="number_document" name="number_document" placeholder="Número de documento" value="<?= $row['Numero_documento']?>" readonly required>
                    </div>
                    <div class="mb-3" style="display: none;">
                        <label for="rol" class="form-label text-dark">Rol</label>
                        <input type="text" name="rol" id="rol" class="form-control border-success text-dark" value="<?= $row['Id_rol'] ?>" readonly>
                    </div>
                    <div class="mb-3">
