...
<body class="bg-light">
    ...
    <div class="container my-5 d-flex justify-content-center">
        <div class="card shadow-sm p-4" style="max-width: 400px; width: 100%;">
            <h1 class="mb-4 text-success text-center">Crear Encuesta</h1>
            <form action="" method="POST">
                <?php include '../../controller/add_survey.php'; ?>
                <div class="mb-3">
                    <label for="quarter" class="form-label text-success">Trimestre</label>
                    <select class="form-select" name="quarter" id="quarter" required>
                        <option disabled selected>Selecciona el trimestre</option>
                ...
                <div class="mb-3">
                    ...
                    <?php include('../../controller/years.php'); Create_years(2024,2100) ?>
                </div>
